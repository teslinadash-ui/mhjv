...
define config.name = _("SchoolSeven")
...
define gui.about = _p("""Это захватывающая и образовательная игра, которая переносит участников в мир школьной жизни, полон увлекательных заданий и интересных испытаний. Игра создана для учащихся, чтобы развивать их навыки, такие как критическое мышление, командная работа и коммуникация, в игровой форме.
""")
...
define config.save_directory = "SchoolSeven-1760768081"
